            ...
            <div class="container-2">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <div class="box">
                            <h4><i class="fa-sharp fa-solid fa-file-pen"></i><span class="icon-text">Attendance (<?php echo $latest_checkin_date; ?>)<br><br><?php echo $total_employee_latest_checkin; ?></h4>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
                    ...
                    <div class="col d-flex align-items-center justify-content-between">
                        ...
                        <form id="filterForm" method="post" action="testing.php">
                            <div class="dropdown">
                                ...
                                <div id="dropdownContent" class="dropdown-content">
                                    ...
                                    <a href="#" name= "Human Resources" onclick="selectOption('Marketing')">Human Resources</a>
                                    <a href="#" name= "Finance and Accounting" onclick="selectOption('Customer Service')">Finance and Accounting</a>
                                    <a href="#" name= "Sales and Marketing" onclick="selectOption('Customer Service')">Sales and Marketing</a>
                                    <a href="#" name= "Information Technology" onclick="selectOption('Customer Service')">Information Technology</a>
                                    <a href="#" name= "Customer Service" onclick="selectOption('Customer Service')">Customer Service</a>
                                    <a href="#" name= "Research and Development" onclick="selectOption('Customer Service')">Research and Development</a>
                                    <a href="#" name= "Production and Manufacturing" onclick="selectOption('Customer Service')">Production and Manufacturing</a>
                                    <a href="#" name= "Supply Chain and Logistics" onclick="selectOption('Customer Service')">Supply Chain and Logistics</a>
                                    <a href="#" name= "Administration and Support" onclick="selectOption('Customer Service')">Administration and Support</a>
                                </div>
                                </div>      
                            </div>
